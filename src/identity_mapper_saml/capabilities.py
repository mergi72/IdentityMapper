...
from identity_mapper_saml.domain import SamlConfig
from identity_mapper_saml.mapper import (
    SamlCandidateMapper,
    SamlIdentityMapper,
    SamlResolution,
)
from identity_mapper_saml.provider import InMemorySamlAssertionStore


class SamlAuthenticationError(ValueError):
